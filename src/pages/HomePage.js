...
const HomePage = () => {
    ...
    const handleChange = (newQuery) => {
        // 받아온 필터 값을 상태로 설정
        //console.log("New query:", newQuery); // 콘솔 추가
        setQuery(newQuery);
    };
    ...
    /*     if (
        ...
        petList.response.body.items.item.forEach((item) => {
            console.log(item.careNm);
        });
    } else {
        console.log("petList structure is not as expected.");
    } */
    console.log("petListdfdf",petList);
