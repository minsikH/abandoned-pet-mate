        ...
        <div className="category">
            <form className="form" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="box-form">
                    ...
                    <select className="select" name="SIGUN_NM" id="SIGUN_NM" value={SIGUN_NM} onChange={onChange}>
                ...
                <div className="box-form">
                    ...
                    <select className="select" name="SPECIES_NM" id="SPECIES_NM" value={SPECIES_NM} onChange={onChange}>
