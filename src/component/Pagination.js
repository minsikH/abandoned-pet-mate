...
const Pagination = ({
  ...
  const goToPreviousPageGroup = () => {
    if (currentPage > 1) {
      ...
      setCurrentPage(newPage > 0 ? newPage : 1); // 음수 페이지 막기
    }
  };
  ...
  return (
    <div className="pagination">
      <button
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.backgroundImage = `url(${firstHoverImage})`)
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.backgroundImage = `url(${firstImage})`)
        }
      ></button>
      <button
        className="prev_btn"
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.backgroundImage = `url(${prevHoverImage})`)
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.backgroundImage = `url(${prevImage})`)
        }
      ></button>
