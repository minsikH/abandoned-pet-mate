...
import { kindCdFormat, neuterYnFormat, sexCdFormatImage, ageFormat } from "../util/format";
...
const PetCard = ({ item, isSelected }) => {
    ...
    const handleClick = () => {
        ...
        // 여기에 장바구니 추가 로직을 추가하세요.
        // 추가된 항목은 알맞은 상태로 관리해야 합니다.
    ...
    return (
        <div className="pet_card" key={isSelected}>
            <figure onClick={() => navigate(`/pet/${item.desertionNo}`)}>
