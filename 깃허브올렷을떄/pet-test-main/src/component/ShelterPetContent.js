...
/*     const items =
        petsInSelectedShelter &&
        petsInSelectedShelter.response &&
        petsInSelectedShelter.response.body &&
        petsInSelectedShelter.response.body.items &&
        petsInSelectedShelter.response.body.items.item; */
